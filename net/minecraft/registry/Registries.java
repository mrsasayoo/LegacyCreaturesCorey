...
public class Registries {
	...
	public static final Registry<IncomingRpcMethod> INCOMING_RPC_METHOD = create(RegistryKeys.INCOMING_RPC_METHODS, IncomingRpcMethods::registerAndGetDefault);
	...
	public static final Registry<MapCodec<? extends Dialog>> DIALOG_TYPE = create(RegistryKeys.DIALOG_TYPE, DialogTypes::registerAndGetDefault);
	...
	public static final Registry<MapCodec<? extends DialogBody>> DIALOG_BODY_TYPE = create(RegistryKeys.DIALOG_BODY_TYPE, DialogBodyTypes::registerAndGetDefault);
	...
	private static <T extends Registry<?>> void validate(Registry<T> registries) {
		registries.forEach(registry -> {
			...
			if (registry instanceof DefaultedRegistry) {
				...
				Objects.requireNonNull(registry.get(identifier), "Missing default of DefaultedMappedRegistry: " + identifier);
			}
		});
	}
