...
public class oppressive_presence_aura_3_action implements mutation_action, OppressivePresenceSource {
    ...
    public oppressive_presence_aura_3_action(mutation_action_config config) {
