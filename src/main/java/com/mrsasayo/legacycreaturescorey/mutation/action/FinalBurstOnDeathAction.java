 ...
 */
public final class FinalBurstOnDeathAction implements MutationAction {
    ...
    private void igniteGround(ServerWorld world, Vec3d origin) {
        ...
        if (!ignited.isEmpty()) {
            MutationTaskScheduler.schedule(world, new FireCleanupTask(List.copyOf(ignited), fireDurationTicks));
        }
    }
    ...
    private static final class FireCleanupTask implements MutationTaskScheduler.TimedTask {
