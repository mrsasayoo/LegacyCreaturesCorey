...
public class oppressive_presence_aura_1_action implements mutation_action, OppressivePresenceSource {
    ...
    public oppressive_presence_aura_1_action(mutation_action_config config) {
